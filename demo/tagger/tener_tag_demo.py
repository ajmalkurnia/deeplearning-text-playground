...
def main(args, data):
    ...
    if args.loadmodel:
        ...
        hybrid_tagger = TENERTagger.load(args.loadmodel)
    else:
        ...
        class_parameter = {
            ...
            "dim_ff": args.dimff,
            "transformer_dropout": args.transformerdropout,
            "attention_dropout": args.attentiondropout,
            "embedding_dropout": args.embeddingdropout,
            "out_transformer_dropout": args.outtransformerdropout,
        }
